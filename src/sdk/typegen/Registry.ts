...
export enum ResolutionErrorInput { AddressIsNotSet = 'AddressIsNotSet', CannotSetPrimaryForUnknownAddress = 'CannotSetPrimaryForUnknownAddress', ExpiredDomain = 'ExpiredDomain', ResolverIsNotSet = 'ResolverIsNotSet' };
export enum ResolutionErrorOutput { AddressIsNotSet = 'AddressIsNotSet', CannotSetPrimaryForUnknownAddress = 'CannotSetPrimaryForUnknownAddress', ExpiredDomain = 'ExpiredDomain', ResolverIsNotSet = 'ResolverIsNotSet' };
...
export type SetPrimaryEventInput = { sender: IdentityInput, asset_id: AssetIdInput };
export type SetPrimaryEventOutput = { sender: IdentityOutput, asset_id: AssetIdOutput };
...
const abi = {
  ...
  "concreteTypes": [
    ...
    {
      "type": "enum errors::RenewalError",
      "concreteTypeId": "36344b8c47fd7120832da8054cc8683521e60cbad32358305c764174faff0d22",
      "metadataTypeId": 4
    },
    {
      "type": "enum errors::ResolutionError",
      "concreteTypeId": "1397ab39f7a7980f29d624d84096e3a50c42f524eecca64788aabb80a66d63ee",
      "metadataTypeId": 5
    },
    {
      "type": "enum errors::UnexpectedError",
      "concreteTypeId": "f94696d0fb2336b36ead803591a5f37e3558b3e5256a35d045051422028db395",
      "metadataTypeId": 6
    },
    {
    ...
    {
      "type": "struct SetPrimaryEvent",
      "concreteTypeId": "232fd110149f38ffddc73b103774bea370c48cd34c24377856fea478452fcc03",
      "metadataTypeId": 16
    },
    {
  ...
  "functions": [
    ...
    },
    {
      ...
      "name": "resolve_to_primary_domain",
  ...
  "loggedTypes": [
    ...
    {
      "logId": "1411785273660381199",
      "concreteTypeId": "1397ab39f7a7980f29d624d84096e3a50c42f524eecca64788aabb80a66d63ee"
    },
    {
      "logId": "2535474982228539647",
      "concreteTypeId": "232fd110149f38ffddc73b103774bea370c48cd34c24377856fea478452fcc03"
    },
    {
...
export class RegistryInterface extends Interface {
  ...
  declare functions: {
    ...
    resolve_to_primary_domain: FunctionFragment;
...
export class Registry extends Contract {
  ...
  declare functions: {
    ...
    resolve_to_primary_domain: InvokeFunction<[identity: IdentityInput], Option<AssetIdOutput>>;
